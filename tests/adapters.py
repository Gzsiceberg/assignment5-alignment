...
def run_tokenize_prompt_and_output(
    ...
    return tokenize_to_tensor(prompt_strs, output_strs, tokenizer)
...
def run_get_response_log_probs(
    ...
    if isinstance(model, PreTrainedModel):
        ...
        raise ValueError("Model must be an instance of PreTrainedModel.")
...
def run_parse_mmlu_response(
    ...
    """
    from cs336_alignment.mmlu_baseline import extract_mmlu_answer
    return extract_mmlu_answer(model_output)
